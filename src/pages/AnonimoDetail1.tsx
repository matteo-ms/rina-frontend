    ...
    return (
        <div className="verifier-anonimo-detail1">
            ...
            <div className="verification-date-group">
                ...
                <div className="title25">12/02/2023</div>
            ...
            <div className="title28">Still Mill SPA</div>
            <div className="ddt-number1">DDT number</div>
            <div className="seller1">Seller</div>
            <div className="title29">180 kg</div>
            <div className="weight">Weight</div>
            <div className="title30">10405060</div>
            <div className="dtt-date1">DTT date</div>
            <div className="title31">27/03/2023</div>
            <div className="delivered-data13">Delivery date</div>
            <div className="title32">29/03/2023</div>
